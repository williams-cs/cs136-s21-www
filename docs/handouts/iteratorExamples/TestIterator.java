...
public class TestIterator {
  ...
  public static void main (String args[]) {
    ...
    // NEVER CHANGE UNDERLYING DATA STRUCTURE DURING ITERATION

    // // infinite iterators
    // System.out.println("Infinite iterator:");
    // Iterator<String> infIt = list1.iterator();
    // while(infIt.hasNext() && list1.size() < 20) {
    //   String s = infIt.next();
    //   list1.add(s);
    //   System.out.print(s+" ");
    // }
    ...
    // while(it4.hasNext() && list4.size() < 20) {
    //   String s = it4.next();
    //   list4.addLast(s);
    //   System.out.print(s+" ");
    // }
